...
const List<_VehiclePaintOption> _vehiclePaintOptions = [
  _VehiclePaintOption('Cheese Yellow', Color(0xFFF2C94C)),
...
String _vehiclePaintLabel(BuildContext context, String label) {
  final key = switch (label) {
    'Cheese Yellow' => 'colorArcticWhite',
...
const Map<_AppLanguage, Map<String, String>> _localizedStrings = {
  _AppLanguage.en: {
    ...
    'tyreLow': 'Low',
    'tyreOk': 'OK',
    'colorArcticWhite': 'Cheese Yellow',
  ...
  _AppLanguage.fr: {
    ...
    'tyreLow': 'Bas',
    'tyreOk': 'OK',
    'colorArcticWhite': 'Jaune Fromage',
  ...
  _AppLanguage.it: {
    ...
    'tyreLow': 'Bassa',
    'tyreOk': 'OK',
    'colorArcticWhite': 'Giallo Formaggio',
