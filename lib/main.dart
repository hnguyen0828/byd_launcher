...
const List<_VehiclePaintOption> _vehiclePaintOptions = [
  _VehiclePaintOption('Copper Orange', Color(0xFFC66A2E)),
  ...
  _VehiclePaintOption('Champagne Gold', Color(0xFFD6B36A)),
  _VehiclePaintOption('Surf Blue', Color(0xFF2DA7D7)),
  _VehiclePaintOption('Delan Black', Color(0xFF090C12)),
  _VehiclePaintOption('Ocean Teal', Color(0xFF007C89)),
  ...
  _VehiclePaintOption('Deep Navy', Color(0xFF102A43)),
...
String _tyreStateLabel(BuildContext context, _TyreSnapshot tyre) {
  if (tyre.signalState == 1) return _t(context, 'tyreSignal');
  if (tyre.airLeakState == 1 || tyre.airLeakState == 2) {
    return _t(context, 'tyreLeak');
  }
  if (tyre.pressureState == 1) return _t(context, 'tyreHigh');
  if (tyre.pressureState == 2) return _t(context, 'tyreLow');
  if (tyre.pressureBar != null) return _t(context, 'tyreOk');
  return '--';
}

String _vehiclePaintLabel(BuildContext context, String label) {
  final key = switch (label) {
    'Copper Orange' => 'colorArcticWhite',
    'Snow White' => 'colorSnowWhite',
    'Sand Cream' => 'colorSandCream',
    'Harbour Grey' => 'colorHarbourGrey',
    'Champagne Gold' => 'colorTimeGrey',
    'Surf Blue' => 'colorSurfBlue',
    'Delan Black' => 'colorDelanBlack',
    'Ocean Teal' => 'colorAzureBlue',
    'Sky Blue' => 'colorSkyBlue',
    'Forest Green' => 'colorForestGreen',
    'Boundless Cloud' => 'colorBoundlessCloud',
    'Parkour Red' => 'colorParkourRed',
    'Deep Navy' => 'colorEmperorRed',
    'Coral Pink' => 'colorCoralPink',
    'Maldive Purple' => 'colorMaldivePurple',
    _ => null,
  };
  return key == null ? label : _t(context, key);
}
...
String _embeddedMapScaleLabel(BuildContext context, _EmbeddedMapScale scale) {
  return switch (scale) {
    _EmbeddedMapScale.compact => _t(context, 'mapScaleCompact'),
    _EmbeddedMapScale.balanced => _t(context, 'mapScaleBalanced'),
    _EmbeddedMapScale.oem => 'OEM',
    _EmbeddedMapScale.comfortable => _t(context, 'mapScaleComfort'),
  };
}
...
const Map<_AppLanguage, Map<String, String>> _localizedStrings = {
  _AppLanguage.en: {
    ...
    'overlay': 'Overlay',
    'internet': 'Internet',
    'renderQualitySubtitle':
        'Lower quality reduces texture resolution and anti-aliasing for smoother rotation.',
    'noMapAppInstalled': 'No map app installed',
    'installMapHint': 'Install Google Map or Waze, then tap reload above.',
    'embeddedNavigationAndroidOnly':
        'Embedded navigation is available on Android.',
    'startingEmbeddedNavigation': 'Starting embedded navigation...',
    'virtualDisplayCouldNotStart': 'Virtual display could not start.',
    'virtualDisplayBlocked': 'Virtual display blocked',
    'restartSelectedMap': 'Restart selected map',
    'hideNavigationControls': 'Hide navigation controls',
    'chooseNavigationApp': 'Choose navigation app',
    'choose': 'Choose',
    'showNavigationControls': 'Show navigation controls',
    'imageCountReady': '{count} images ready',
    'off': 'Off',
    'auto': 'Auto',
    'qualityLow': 'Low',
    'qualityMedium': 'Medium',
    'qualityHigh': 'High',
    'mapScaleCompact': 'Compact',
    'mapScaleBalanced': 'Balanced',
    'mapScaleComfort': 'Comfort',
    'lightOff': 'Light Off',
    'lowBeam': 'Low Beam',
    'highBeam': 'High Beam',
    'fog': 'Fog',
    ...
    'tyreLow': 'Low',
    'tyreOk': 'OK',
    'colorArcticWhite': 'Copper Orange',
    'colorSnowWhite': 'Snow White',
    'colorSandCream': 'Sand Cream',
    'colorHarbourGrey': 'Harbour Grey',
    'colorTimeGrey': 'Champagne Gold',
    'colorSurfBlue': 'Surf Blue',
    'colorDelanBlack': 'Delan Black',
    'colorAzureBlue': 'Ocean Teal',
    'colorSkyBlue': 'Sky Blue',
    'colorForestGreen': 'Forest Green',
    'colorBoundlessCloud': 'Boundless Cloud',
    'colorParkourRed': 'Parkour Red',
    'colorEmperorRed': 'Deep Navy',
    'colorCoralPink': 'Coral Pink',
    'colorMaldivePurple': 'Maldive Purple',
  },
  _AppLanguage.vi: {
    'appTitle': 'Kim Launcher',
    'language': 'Ngôn ngữ',
    ...
    'internet': 'Internet',
    'renderQualitySubtitle':
        'Chất lượng thấp giảm độ phân giải texture và khử răng cưa để xoay mượt hơn.',
    'noMapAppInstalled': 'Chưa cài app bản đồ',
    'installMapHint': 'Cài Google Map hoặc Waze rồi bấm tải lại ở trên.',
    'embeddedNavigationAndroidOnly':
        'Dẫn đường nhúng chỉ khả dụng trên Android.',
    'startingEmbeddedNavigation': 'Đang mở dẫn đường nhúng...',
    'virtualDisplayCouldNotStart': 'Không thể khởi động màn hình ảo.',
    'virtualDisplayBlocked': 'Màn hình ảo bị chặn',
    'restartSelectedMap': 'Khởi động lại bản đồ đã chọn',
    'hideNavigationControls': 'Ẩn điều khiển dẫn đường',
    'chooseNavigationApp': 'Chọn app dẫn đường',
    'choose': 'Chọn',
    'showNavigationControls': 'Hiện điều khiển dẫn đường',
    'imageCountReady': '{count} ảnh sẵn sàng',
    'off': 'Tắt',
    'auto': 'Tự động',
    'qualityLow': 'Thấp',
    'qualityMedium': 'Vừa',
    'qualityHigh': 'Cao',
    'mapScaleCompact': 'Gọn',
    'mapScaleBalanced': 'Cân bằng',
    'mapScaleComfort': 'Thoải mái',
    'lightOff': 'Tắt đèn',
    'lowBeam': 'Đèn cos',
    'highBeam': 'Đèn pha',
    'fog': 'Đèn sương mù',
    ...
    'rearRightWindow': 'Kính sau phải',
    'sunroof': 'Cửa sổ trời',
    'roofShort': 'Nóc',
    'trunk': 'Cốp',
    'openPercent': 'Mở {percent}%',
    'close': 'Đóng',
    'open': 'Mở',
    'tyreSignal': 'Tín hiệu',
    'tyreLeak': 'Rò khí',
    ...
    'tyreLow': 'Thấp',
    'tyreOk': 'OK',
    'colorArcticWhite': 'Cam Copper',
    'colorSnowWhite': 'Trắng tuyết',
    'colorSandCream': 'Kem cát',
    'colorHarbourGrey': 'Xám Harbour',
    'colorTimeGrey': 'Xám Time',
    'colorSurfBlue': 'Xanh Surf',
    'colorDelanBlack': 'Đen Delan',
    'colorAzureBlue': 'Xanh Ocean',
    'colorSkyBlue': 'Xanh trời',
    'colorForestGreen': 'Xanh rừng',
    'colorBoundlessCloud': 'Mây Boundless',
    'colorParkourRed': 'Đỏ Parkour',
    'colorEmperorRed': 'Xanh Navy',
    'colorCoralPink': 'Hồng Coral',
    'colorMaldivePurple': 'Tím Maldive',
  },
  _AppLanguage.zh: {
    'appTitle': 'Kim Launcher',
    'language': '语言',
    ...
    'settings': '设置',
    'settingsSubtitle': '启动器和车辆显示偏好',
    'vehicle': '车辆',
    'navigation': '导航',
    'navShort': '导航',
    'ambient': '氛围',
    'layout': '布局',
    'layoutSubtitle': '在横屏和竖屏布局之间切换。',
    'sidebarPosition': '横屏侧边栏',
    'sidebarPositionSubtitle': '为左舵或右舵车辆移动车辆侧边栏。',
    'sidebarLeft': '左',
    'sidebarRight': '右',
    'landscapeShort': '横屏',
    'portraitShort': '竖屏',
    'defaultLauncher': '默认启动器',
    'defaultLauncherReady': '车机启动时会打开此启动器。',
    'defaultLauncherChoose': '将此应用设为系统主页启动器。',
    'launchNavigation': '启动导航',
    'launchNavigationReady': '启动器打开时启动默认地图应用。',
    'launchNavigationMissing': '启用前请安装或刷新地图应用。',
    'mapScale': '地图缩放',
    'mapScaleSubtitle': '调整嵌入地图文字和按钮大小。',
    'vehicleModel': '车辆模型',
    'vehicleModelSubtitle': '选择首页显示的 3D 模型。',
    'vehicleColor': '车身颜色',
    'vehicleColorSubtitle': '用于启动器预览和后续渲染状态。',
    'appearance': '外观',
    'appearanceSubtitle': '选择浅色、深色或跟随系统。',
    'light': '浅色',
    'dark': '深色',
    'system': '系统',
    'renderQuality': '3D 渲染质量',
    'renderQualitySubtitle': '较低质量会降低纹理分辨率和抗锯齿，让旋转更流畅。',
    'lightEffect': '灯光效果',
    'lightEffectSubtitle': '在车辆上显示动态光束叠加。',
    'debugMode': '调试模式',
    'debugModeSubtitle': '启用演示档位和灯光控制。',
    'aboutApp': '关于',
    'aboutAppSubtitle': '应用信息和维护者详情。',
    'contactEmail': '邮箱',
    'developedBy': '开发者',
    'version': '版本',
    'ambientSubtitle': '使用应用 Ambient 文件夹中的图片。',
    'showAmbientButton': '显示 Ambient 按钮',
    'showAmbientButtonSubtitle': '显示或隐藏底部 Dock 的 Ambient 标签。',
    'autoChangeInterval': '自动切换间隔',
    'add': '添加',
    'cancel': '取消',
    'refresh': '刷新',
    'favoriteApps': '收藏应用',
    'noAmbientImages': '未找到 Ambient 图片',
    'ambientEmptyHint': '将 JPG、PNG 或 WEBP 图片放入 Ambient 文件夹，然后点刷新。',
    'noLaunchableApps': '未找到可启动应用',
    'saveCount': '保存 ({count}/10)',
    'vehicleStatus': '状态',
    'tpms': '胎压',
    'music': '音乐',
    'unknownTrack': '未知曲目',
    'enableMusicAccess': '在设置中启用音乐访问',
    'systemPermissions': '系统权限',
    'systemPermissionsSubtitle': '一键设置音乐、悬浮窗、嵌入导航和启动器桥接。',
    'checkingPermissions': '正在检查权限',
    'permissionsReady': '权限已就绪',
    'grantAllPermissions': '授予所有权限',
    'allPermissionsReady': '所有权限已就绪',
    'permissionsReadyCount': '{ready}/{total} 项权限就绪',
    'overlay': '悬浮窗',
    'internet': '互联网',
    'range': '续航',
    'fuel': '燃油',
    'battery': '电池',
    'noMapAppInstalled': '未安装地图应用',
    'installMapHint': '安装 Google Map 或 Waze，然后点击上方刷新。',
    'embeddedNavigationAndroidOnly': '嵌入导航仅在 Android 上可用。',
    'startingEmbeddedNavigation': '正在启动嵌入导航...',
    'virtualDisplayCouldNotStart': '无法启动虚拟显示。',
    'virtualDisplayBlocked': '虚拟显示被阻止',
    'restartSelectedMap': '重启所选地图',
    'hideNavigationControls': '隐藏导航控制',
    'chooseNavigationApp': '选择导航应用',
    'choose': '选择',
    'showNavigationControls': '显示导航控制',
    'imageCountReady': '{count} 张图片就绪',
    'off': '关闭',
    'auto': '自动',
    'qualityLow': '低',
    'qualityMedium': '中',
    ...
    'signalLeft': '左转灯',
    'signalRight': '右转灯',
    'frontLeftWindow': '左前车窗',
    'frontRightWindow': '右前车窗',
    'rearLeftWindow': '左后车窗',
    'rearRightWindow': '右后车窗',
    'sunroof': '天窗',
    'roofShort': '车顶',
    'trunk': '后备箱',
    'openPercent': '打开 {percent}%',
    'close': '关闭',
    'open': '打开',
    'tyreSignal': '信号',
    'tyreLeak': '漏气',
    ...
    'colorSnowWhite': '雪白',
    'colorSandCream': '沙米色',
    'colorHarbourGrey': '港湾灰',
    'colorTimeGrey': '时光灰',
    'colorSurfBlue': '浪潮蓝',
    'colorDelanBlack': '德兰黑',
    'colorAzureBlue': '海洋青',
    'colorSkyBlue': '天空蓝',
    'colorForestGreen': '森林绿',
    'colorBoundlessCloud': '无界云',
    'colorParkourRed': '跑酷红',
    'colorEmperorRed': '深海军蓝',
    'colorCoralPink': '珊瑚粉',
    'colorMaldivePurple': '马尔代夫紫',
  },
  _AppLanguage.th: {
    'appTitle': 'Kim Launcher',
    'language': 'ภาษา',
    ...
    'battery': 'แบตเตอรี่',
    'renderQualitySubtitle':
        'คุณภาพต่ำจะลดความละเอียดพื้นผิวและการลบรอยหยักเพื่อให้หมุนลื่นขึ้น',
    'noMapAppInstalled': 'ยังไม่ได้ติดตั้งแอปแผนที่',
    'installMapHint': 'ติดตั้ง Google Map หรือ Waze แล้วแตะรีเฟรชด้านบน',
    'embeddedNavigationAndroidOnly': 'นำทางแบบฝังใช้ได้บน Android เท่านั้น',
    'startingEmbeddedNavigation': 'กำลังเริ่มนำทางแบบฝัง...',
    'virtualDisplayCouldNotStart': 'ไม่สามารถเริ่มจอเสมือนได้',
    'virtualDisplayBlocked': 'จอเสมือนถูกบล็อก',
    'restartSelectedMap': 'เริ่มแผนที่ที่เลือกใหม่',
    'hideNavigationControls': 'ซ่อนปุ่มควบคุมนำทาง',
    'chooseNavigationApp': 'เลือกแอปนำทาง',
    'choose': 'เลือก',
    'showNavigationControls': 'แสดงปุ่มควบคุมนำทาง',
    'imageCountReady': 'พร้อมแล้ว {count} รูป',
    'off': 'ปิด',
    'auto': 'อัตโนมัติ',
    'qualityLow': 'ต่ำ',
    'qualityMedium': 'กลาง',
    'qualityHigh': 'สูง',
    'mapScaleCompact': 'กะทัดรัด',
    'mapScaleBalanced': 'สมดุล',
    'mapScaleComfort': 'สบาย',
    'lightOff': 'ปิดไฟ',
    'lowBeam': 'ไฟต่ำ',
    'highBeam': 'ไฟสูง',
    'fog': 'ไฟตัดหมอก',
    'signalLeft': 'เลี้ยวซ้าย',
    'signalRight': 'เลี้ยวขวา',
    'frontLeftWindow': 'กระจกหน้าซ้าย',
    'frontRightWindow': 'กระจกหน้าขวา',
    'rearLeftWindow': 'กระจกหลังซ้าย',
    'rearRightWindow': 'กระจกหลังขวา',
    'sunroof': 'ซันรูฟ',
    'roofShort': 'หลังคา',
    'trunk': 'ท้ายรถ',
    'openPercent': 'เปิด {percent}%',
    'close': 'ปิด',
    'open': 'เปิด',
    'tyreSignal': 'สัญญาณ',
    'tyreLeak': 'รั่ว',
    ...
    'tyreLow': 'ต่ำ',
    'tyreOk': 'OK',
    'colorArcticWhite': 'ส้ม Copper',
    'colorSnowWhite': 'ขาวหิมะ',
    'colorSandCream': 'ครีมทราย',
    'colorHarbourGrey': 'เทา Harbour',
    'colorTimeGrey': 'เทา Time',
    'colorSurfBlue': 'ฟ้า Surf',
    'colorDelanBlack': 'ดำ Delan',
    'colorAzureBlue': 'เขียวอมฟ้า Ocean',
    'colorSkyBlue': 'ฟ้า Sky',
    'colorForestGreen': 'เขียว Forest',
    'colorBoundlessCloud': 'Boundless Cloud',
    'colorParkourRed': 'แดง Parkour',
    'colorEmperorRed': 'น้ำเงิน Deep Navy',
    'colorCoralPink': 'ชมพู Coral',
    'colorMaldivePurple': 'ม่วง Maldive',
  },
  _AppLanguage.id: {
    'appTitle': 'Kim Launcher',
    'language': 'Bahasa',
    ...
    'battery': 'Baterai',
    'renderQualitySubtitle':
        'Kualitas rendah mengurangi resolusi tekstur dan anti-aliasing agar rotasi lebih halus.',
    'noMapAppInstalled': 'Aplikasi peta belum terpasang',
    'installMapHint':
        'Pasang Google Map atau Waze, lalu ketuk muat ulang di atas.',
    'embeddedNavigationAndroidOnly': 'Navigasi tertanam tersedia di Android.',
    'startingEmbeddedNavigation': 'Memulai navigasi tertanam...',
    'virtualDisplayCouldNotStart': 'Display virtual tidak dapat dimulai.',
    'virtualDisplayBlocked': 'Display virtual diblokir',
    'restartSelectedMap': 'Mulai ulang peta terpilih',
    'hideNavigationControls': 'Sembunyikan kontrol navigasi',
    'chooseNavigationApp': 'Pilih aplikasi navigasi',
    'choose': 'Pilih',
    'showNavigationControls': 'Tampilkan kontrol navigasi',
    'imageCountReady': '{count} gambar siap',
    'off': 'Mati',
    'auto': 'Otomatis',
    'qualityLow': 'Rendah',
    'qualityMedium': 'Sedang',
    'qualityHigh': 'Tinggi',
    'mapScaleCompact': 'Ringkas',
    'mapScaleBalanced': 'Seimbang',
    'mapScaleComfort': 'Nyaman',
    'lightOff': 'Lampu mati',
    'lowBeam': 'Lampu dekat',
    'highBeam': 'Lampu jauh',
    'fog': 'Kabut',
    'signalLeft': 'Sein kiri',
    'signalRight': 'Sein kanan',
    'frontLeftWindow': 'Jendela depan kiri',
    'frontRightWindow': 'Jendela depan kanan',
    'rearLeftWindow': 'Jendela belakang kiri',
    'rearRightWindow': 'Jendela belakang kanan',
    'sunroof': 'Sunroof',
    'roofShort': 'Atap',
    'trunk': 'Bagasi',
    'openPercent': '{percent}% terbuka',
    'close': 'Tutup',
    'open': 'Buka',
    'tyreSignal': 'Sinyal',
    'tyreLeak': 'Bocor',
    ...
    'tyreLow': 'Rendah',
    'tyreOk': 'OK',
    'colorArcticWhite': 'Oranye Copper',
    'colorSnowWhite': 'Putih salju',
    'colorSandCream': 'Krem pasir',
    'colorHarbourGrey': 'Abu Harbour',
    'colorTimeGrey': 'Abu Time',
    'colorSurfBlue': 'Biru Surf',
    'colorDelanBlack': 'Hitam Delan',
    'colorAzureBlue': 'Ocean Teal',
    'colorSkyBlue': 'Biru langit',
    'colorForestGreen': 'Hijau hutan',
    'colorBoundlessCloud': 'Boundless Cloud',
    'colorParkourRed': 'Merah Parkour',
    'colorEmperorRed': 'Biru Deep Navy',
    'colorCoralPink': 'Pink Coral',
    'colorMaldivePurple': 'Ungu Maldive',
  },
  _AppLanguage.fr: {
    'appTitle': 'Kim Launcher',
    'language': 'Langue',
    ...
    'battery': 'Batterie',
    'renderQualitySubtitle':
        'Une qualité plus basse réduit la résolution des textures et l’anticrénelage pour une rotation plus fluide.',
    'noMapAppInstalled': 'Aucune app de carte installée',
    'installMapHint':
        'Installez Google Map ou Waze, puis touchez Actualiser ci-dessus.',
    'embeddedNavigationAndroidOnly':
        'La navigation intégrée est disponible sur Android.',
    'startingEmbeddedNavigation': 'Démarrage de la navigation intégrée...',
    'virtualDisplayCouldNotStart': 'Impossible de démarrer l’écran virtuel.',
    'virtualDisplayBlocked': 'Écran virtuel bloqué',
    'restartSelectedMap': 'Redémarrer la carte sélectionnée',
    'hideNavigationControls': 'Masquer les contrôles de navigation',
    'chooseNavigationApp': 'Choisir l’app de navigation',
    'choose': 'Choisir',
    'showNavigationControls': 'Afficher les contrôles de navigation',
    'imageCountReady': '{count} images prêtes',
    'off': 'Désactivé',
    'auto': 'Auto',
    'qualityLow': 'Faible',
    ...
    'qualityHigh': 'Élevée',
    'mapScaleCompact': 'Compact',
    'mapScaleBalanced': 'Équilibré',
    'mapScaleComfort': 'Confort',
    'lightOff': 'Feux éteints',
    'lowBeam': 'Feux de croisement',
    'highBeam': 'Pleins phares',
    'fog': 'Brouillard',
    'signalLeft': 'Clign. G',
    'signalRight': 'Clign. D',
    'frontLeftWindow': 'Vitre avant gauche',
    'frontRightWindow': 'Vitre avant droite',
    'rearLeftWindow': 'Vitre arrière gauche',
    'rearRightWindow': 'Vitre arrière droite',
    'sunroof': 'Toit ouvrant',
    'roofShort': 'Toit',
    'trunk': 'Coffre',
    'openPercent': 'Ouvert à {percent}%',
    'close': 'Fermer',
    'open': 'Ouvrir',
    'tyreSignal': 'Signal',
    'tyreLeak': 'Fuite',
    ...
    'tyreLow': 'Bas',
    'tyreOk': 'OK',
    'colorArcticWhite': 'Orange cuivre',
    'colorSnowWhite': 'Blanc neige',
    'colorSandCream': 'Crème sable',
    'colorHarbourGrey': 'Gris Harbour',
    'colorTimeGrey': 'Gris Time',
    'colorSurfBlue': 'Bleu Surf',
    'colorDelanBlack': 'Noir Delan',
    'colorAzureBlue': 'Bleu sarcelle océan',
    'colorSkyBlue': 'Bleu ciel',
    'colorForestGreen': 'Vert forêt',
    'colorBoundlessCloud': 'Nuage Boundless',
    'colorParkourRed': 'Rouge Parkour',
    'colorEmperorRed': 'Bleu marine profond',
    'colorCoralPink': 'Rose Coral',
    'colorMaldivePurple': 'Violet Maldive',
  },
  _AppLanguage.it: {
    'appTitle': 'Kim Launcher',
    'language': 'Lingua',
    ...
    'battery': 'Batteria',
    'renderQualitySubtitle':
        'Una qualità più bassa riduce risoluzione texture e anti-aliasing per una rotazione più fluida.',
    'noMapAppInstalled': 'Nessuna app mappe installata',
    'installMapHint': 'Installa Google Map o Waze, poi tocca Aggiorna in alto.',
    'embeddedNavigationAndroidOnly':
        'La navigazione integrata è disponibile su Android.',
    'startingEmbeddedNavigation': 'Avvio navigazione integrata...',
    'virtualDisplayCouldNotStart': 'Impossibile avviare il display virtuale.',
    'virtualDisplayBlocked': 'Display virtuale bloccato',
    'restartSelectedMap': 'Riavvia mappa selezionata',
    'hideNavigationControls': 'Nascondi controlli navigazione',
    'chooseNavigationApp': 'Scegli app navigazione',
    'choose': 'Scegli',
    'showNavigationControls': 'Mostra controlli navigazione',
    'imageCountReady': '{count} immagini pronte',
    'off': 'Off',
    'auto': 'Auto',
    'qualityLow': 'Bassa',
    'qualityMedium': 'Media',
    'qualityHigh': 'Alta',
    'mapScaleCompact': 'Compatta',
    'mapScaleBalanced': 'Bilanciata',
    'mapScaleComfort': 'Comoda',
    'lightOff': 'Luci spente',
    'lowBeam': 'Anabbaglianti',
    'highBeam': 'Abbaglianti',
    'fog': 'Fendinebbia',
    'signalLeft': 'Freccia S',
    'signalRight': 'Freccia D',
    'frontLeftWindow': 'Finestrino ant. sinistro',
    'frontRightWindow': 'Finestrino ant. destro',
    'rearLeftWindow': 'Finestrino post. sinistro',
    'rearRightWindow': 'Finestrino post. destro',
    'sunroof': 'Tetto apribile',
    'roofShort': 'Tetto',
    'trunk': 'Bagagliaio',
    'openPercent': 'Aperto {percent}%',
    'close': 'Chiudi',
    'open': 'Apri',
    'tyreSignal': 'Segnale',
    'tyreLeak': 'Perdita',
    ...
    'tyreLow': 'Bassa',
    'tyreOk': 'OK',
    'colorArcticWhite': 'Arancione rame',
    'colorSnowWhite': 'Bianco neve',
    'colorSandCream': 'Crema sabbia',
    'colorHarbourGrey': 'Grigio Harbour',
    'colorTimeGrey': 'Grigio Time',
    'colorSurfBlue': 'Blu Surf',
    'colorDelanBlack': 'Nero Delan',
    'colorAzureBlue': 'Verde acqua oceano',
    'colorSkyBlue': 'Azzurro cielo',
    'colorForestGreen': 'Verde foresta',
    'colorBoundlessCloud': 'Boundless Cloud',
    'colorParkourRed': 'Rosso Parkour',
    'colorEmperorRed': 'Blu navy profondo',
    'colorCoralPink': 'Rosa Coral',
    'colorMaldivePurple': 'Viola Maldive',
  },
};
            ...
            children: [
              ...
              Positioned(
                ...
                child: _PressureBlock(
                  ...
                  temp: _tyreStateLabel(context, snapshot.tyre('frontLeft')),
                ),
              ),
              Positioned(
                right: 0,
                ...
                child: _PressureBlock(
                  ...
                  temp: _tyreStateLabel(context, snapshot.tyre('frontRight')),
                  alignRight: true,
                ),
              ),
              Positioned(
                ...
                child: _PressureBlock(
                  ...
                  temp: _tyreStateLabel(context, snapshot.tyre('rearLeft')),
                ),
              ),
              Positioned(
                right: 0,
                ...
                child: _PressureBlock(
                  ...
                  temp: _tyreStateLabel(context, snapshot.tyre('rearRight')),
                  alignRight: true,
                ),
              ),
  ...
  Widget build(BuildContext context) {
    ...
    if (app == null) {
      return _EmbeddedNavigationFallback(
        ...
        title: _t(context, 'noMapAppInstalled'),
        subtitle: _t(context, 'installMapHint'),
      );
    }
    ...
    return _EmbeddedNavigationFallback(
      ...
      subtitle: _t(context, 'embeddedNavigationAndroidOnly'),
      onTap: onOpen,
    );
  }
}
        ...
        if (textureId == null) {
          return _EmbeddedNavigationFallback(
            ...
            subtitle: _error == null
                ? _t(context, 'startingEmbeddedNavigation')
                : _t(context, 'virtualDisplayCouldNotStart'),
          );
        }
                ...
                Positioned(
                  ...
                  child: IgnorePointer(
                    child: _MapStatusPill(
                      ...
                      label: _t(context, 'virtualDisplayBlocked'),
                    ),
                  ),
                ),
            ],
              ...
              child: Row(
                ...
                children: [
                  ...
                  _NavigationTopIconButton(
                    ...
                    tooltip: _t(context, 'restartSelectedMap'),
                    onTap: onReload,
                  ),
                  const SizedBox(width: 4),
                  _NavigationTopIconButton(
                    icon: Icons.fullscreen_rounded,
                    tooltip: _t(context, 'hideNavigationControls'),
                    onTap: onCollapse,
                  ),
                  const SizedBox(width: 4),
                  PopupMenuButton<_NavigationApp>(
                    tooltip: _t(context, 'chooseNavigationApp'),
...
class _NavigationCollapsedButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final light = _isLight(context);
    return Tooltip(
      message: _t(context, 'showNavigationControls'),
      child: InkWell(
        borderRadius: BorderRadius.circular(999),
        onTap: onTap,
        child: ClipRRect(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      _tx(context, 'imageCountReady', {'count': imageCount}),
                      style: _sharp(
                        context,
                        Theme.of(context).textTheme.labelMedium,
                        color: _textMuted,
                      ...
                      for (final option in _vehiclePaintOptions)
                        SizedBox(
                          ...
                          child: _VehicleColorSwatch(
                            label: _vehiclePaintLabel(context, option.label),
                            color: option.color,
          ...
          child: Column(
            ...
            children: [
              _SettingsSectionTitle(
                ...
                subtitle: _t(context, 'renderQualitySubtitle'),
              ),
              const SizedBox(height: 14),
      ...
      child: Row(
        children: [
          for (final scale in _EmbeddedMapScale.values)
            _MapScaleOption(
              label: _embeddedMapScaleLabel(context, scale),
...
String _demoLightLabel(BuildContext context, _DemoLightMode mode) {
  return switch (mode) {
    _DemoLightMode.off => _t(context, 'lightOff'),
    _DemoLightMode.auto => _t(context, 'auto'),
    _DemoLightMode.lowBeam => _t(context, 'lowBeam'),
    _DemoLightMode.highBeam => _t(context, 'highBeam'),
    _DemoLightMode.fog => _t(context, 'fog'),
    _DemoLightMode.turnLeft => _t(context, 'signalLeft'),
    _DemoLightMode.turnRight => _t(context, 'signalRight'),
  };
}
  ...
  List<_HotspotSpec> _buildProjectedHotspots({
    ...
    final rawSpots = <_HotspotSpec>[
      ...
      _HotspotSpec(
        ...
        label: _t(context, 'frontLeftWindow'),
        shortLabel: 'FL',
      ...
      _HotspotSpec(
        ...
        label: _t(context, 'frontRightWindow'),
        shortLabel: 'FR',
        icon: Icons.window_outlined,
        position: project(0.50, 0.20, 0.28),
        cardAlignment: sideAlignment(0.50, 0.28),
      ...
      _HotspotSpec(
        ...
        label: _t(context, 'rearLeftWindow'),
        shortLabel: 'RL',
        icon: Icons.window_outlined,
      ...
      _HotspotSpec(
        ...
        label: _t(context, 'rearRightWindow'),
        shortLabel: 'RR',
        icon: Icons.window_outlined,
        position: project(0.50, 0.19, -0.36),
        cardAlignment: sideAlignment(0.50, -0.36),
      ...
      _HotspotSpec(
        ...
        label: _t(context, 'sunroof'),
        shortLabel: _t(context, 'roofShort'),
      ...
      _HotspotSpec(
        ...
        label: _t(context, 'trunk'),
        shortLabel: _t(context, 'trunk'),
...
class _DrivingRoadPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final roadCenterWashPath = Path()
      ...
      ..close();
    final roadCenterWashPaint = Paint()
      ..shader = LinearGradient(
        begin: Alignment.topCenter,
        end: Alignment.bottomCenter,
        colors: light
    ...
    void drawFadedEdge(double side) {
      ...
      var previous = roadPoint(edgeStartT, side);
    ...
    for (var i = -2; i < 7; i++) {
      ...
      final horizonFade = ((t - laneStartT) / 0.22).clamp(0.0, 1.0);
      final nearFade = (1.0 - ((t - 0.80).clamp(0.0, 0.20) / 0.20)).clamp(
        0.0,
        1.0,
      );
      final alpha = distanceFade * horizonFade * nearFade;
      if (alpha <= 0.01) {
        continue;
      }
